...
const endpointSuffix = /\/(?:v1\/(?:models|chat\/completions|responses|images\/(?:generations|edits)|video\/generations|videos(?:\/[^/]+)?)|v1beta\/models\/[^/]+:generateContent|xais\/(?:userProfile|workerTaskStart|workerTaskWait|attUrls|fileAttachmentUploadUrl))\/?$/i;
